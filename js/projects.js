...
const projectsData = {
    ...
    "Фасад 'Скандинавский стиль'": {
        ...
        time: '3 недели',
        price: 'от 450 000 ₽',
        description: 'Современная отделка фасада в скандинавском стиле с использованием натуральных материалов и энергоэффективных решений.',
        features: [
    ...
    "Фасад 'Классический'": {
        ...
        time: '4 недели',
        price: 'от 680 000 ₽',
        description: 'Классическая отделка фасада с элементами традиционной архитектуры и современными технологиями.',
        features: [
    ...
    "Фасад 'Современный'": {
        ...
        time: '2.5 недели',
        price: 'от 520 000 ₽',
        description: 'Современный подход к отделке фасада с использованием инновационных материалов и дизайнерских решений.',
        features: [
